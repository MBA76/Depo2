        ...
        <form action="" class="form-horizontal" method="post">
            <div class="row">
                <table>
                    <th>
                        <tr>
                            <div class="myDiv"><label for="inputEmail3" style="color:White">Bilgileri Giriniz</label>
                            </div>
                        </tr>
                    </th>
                    <tr>
                                ...
                                <div class="col-sm-10">
                                    <th>
                                        <input type="text" class="form-control" id="inputEmail3"
                                               placeholder="Kategori Adı" name="Kat_Adi">
                                    </th>
                                </div>
                            </div>
                        </div>
                    ...
                    <td>
                        <div class="col-sm-12 col-md-12">
                            <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <button type="submit" class="btn btn-default form-control" style="width: 250px;">
                                        Kategori Ekle
                                    </button>
                                </div>
                            </div>
                    ...
                    <tr>
                        <table>
                            <th>
                                <tr>
                                    <div class="myDiv"><label for="inputEmail3" style="color:White">Tüm
                                            Kategoriler</label></div>
                                </tr>
                            </th>
                            <div class="row">
                                <?php
                                ...
                                <div class="col-sm-12 col-md-12">
                                    <div class="panel panel-default">
                                        ...
                                        <table class="table">
                                            ...
                                            <tr>
                                                <th bgcolor="#dddddd"
                                                    style="text-align: center; vertical-align: middle;">Kategori Adı
                                                </th>
                                            </thead>
                                            <tbody>
                                            <?php
