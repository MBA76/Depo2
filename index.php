            ...
            <div class="row">
                ...
                <div class="col-sm-6 col-md-4">
                    <div class="thumbnail">
                        ...
                        <div class="caption">
                            ...
                            <center><a href="stokta-bulunan-urunler.php" class="btn btn-primary" role="button">Stokta Bulunan Ürünler</a> </center>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-sm-6 col-md-4">
                    <div class="thumbnail">
                        ...
                        <div class="caption">
                            <center><a href="distributor-ekle.php" class="btn btn-primary" role="button">Distributor Ekle</a> </center>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-sm-6 col-md-4">
                    <div class="thumbnail">
                        ...
                        <div class="caption">
                            <center><a href="kategori-ekle.php" class="btn btn-primary" role="button">Kategori Ekle</a> </center>
                        </div>
                    </div>
                </div>
