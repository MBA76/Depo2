                ...
                <div class="row">
                    ...
                    <div class="col-sm-4 col-md-4">
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                ...
                                <input type="text" class="form-control" id="bc" name="barkod" placeholder="Barkod Taratın yada yazın">
                            </div>
                        </div>
                    ...
                    <div class="col-sm-4 col-md-4">
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" id="" name="Urun_Kodu" value="" placeholder="ürün Kodu">
                            </div>
                        </div>
                    </div>
                    <div>
                            ...
                            <div class="col-sm-4 col-md-4">
                                <div class="form-group">
                                    <table>
                                        <tr>
                                            <th>
                                                <label for="inputEmail3" class="col-sm-2 control-label">Geldiği Firma</label>
                                            </th>
                                            <th>
                                                <div class="col-sm-10">
